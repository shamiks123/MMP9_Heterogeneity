...
class CellMigration2DSteppable(SteppableBasePy):    
    ...
    def start(self):
        for cell in self.cellListByType(1,2):
            fileName1='InitialVolume.csv'
            if cell.type == 1:
                cell.targetVolume = 214.00
            ...
            if cell.type == 2:                
                ...
                cell.lambdaSurface = 0.125
            try:
                fileHandle,fullFileName=self.openFileInSimulationOutputDirectory(fileName1,"a")
            except IOError:
                print "Could not open file ", fileName1," for writing. "
                return
            print >>fileHandle,cell.type,",",cell.targetVolume,",",cell.lambdaVolume,",",cell.targetSurface,",",cell.lambdaSurface 
    def step(self,mcs):
        pass
    def finish(self):
